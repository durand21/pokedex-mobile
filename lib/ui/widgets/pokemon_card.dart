  ...
  Widget build(BuildContext context) {
    final baseColor =
        typeColors[pokemon.types.isNotEmpty ? pokemon.types[0] : 'normal'] ??
            Colors.grey;
    final baseColorDark = Color.alphaBlend(Colors.black.withOpacity(0.2), baseColor);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: baseColorDark/*Colors.black87*/, width: 2), // borde estilo carta
          boxShadow: [
            BoxShadow(
